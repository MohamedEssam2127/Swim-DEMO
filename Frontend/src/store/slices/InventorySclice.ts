...
const userInfo: { organizationID: string } | null = localStorage.getItem("user")
...
export const fetchInventoryForLocation = createAsyncThunk<
  InventoryItem[],
  string
>("inventory/fetchInventoryForLocation", async (locationId: string) => {
...
>("inventory/createLocation", async (locationData) => {

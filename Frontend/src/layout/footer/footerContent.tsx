  ...
  return (
    <footer className="hidden lg:block relative w-full bg-[#0a2342] overflow-hidden py-8 md:py-12">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
        <span className="absolute top-[10%] right-[10%] text-[#051426] text-[5rem] md:text-[8rem] header uppercase leading-none mix-blend-multiply opacity-60">
          S
        </span>
        <span className="absolute bottom-[-10%] right-[5%] text-[#051426] text-[5rem] md:text-[8rem] header uppercase leading-none mix-blend-multiply opacity-60">
          W
        </span>
        <span className="absolute bottom-[10%] left-[35%] text-[#051426] text-[5rem] md:text-[8rem] header uppercase leading-none mix-blend-multiply opacity-60">
          i
        </span>
        <span className="absolute bottom-[-10%] left-[5%] text-[#051426] text-[5rem] md:text-[8rem] header uppercase leading-none mix-blend-multiply opacity-60">
          M
        </span>
      </div>

...
const CATALOGUE_ITEMS = [
  {
    value: "hw-001",
    label: "HW-001 — Precision Encoder Module",
    unitPrice: 149.99,
  },
  {
    value: "hw-002",
    label: "HW-002 — 48V Power Distribution Unit",
    unitPrice: 299.0,
  },
  {
    value: "hw-003",
    label: "HW-003 — Industrial Temperature Sensor",
    unitPrice: 59.5,
  },
  {
    value: "hw-004",
    label: "HW-004 — Servo Motor Driver (5A)",
    unitPrice: 89.0,
  },
  {
    value: "hw-005",
    label: "HW-005 — Ethernet Gateway Controller",
    unitPrice: 210.0,
  },
];
...
function Order() {
  ...
  const selectedCatalogueItem = CATALOGUE_ITEMS.find(
    (i) => i.value === selectedItem,
  );
  const estimatedTotal = selectedCatalogueItem
    ? selectedCatalogueItem.unitPrice * quantity
    : 0;
